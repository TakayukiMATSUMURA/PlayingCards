...
namespace PlayingCards.Poker
{
    ...
    public class Hand : PlayingCards.Hand
    {
        ...
        public Hand(List<PlayingCards.Card> pocketCards, List<PlayingCards.Card> communityCards) : this(new List<List<PlayingCards.Card>> { pocketCards, communityCards }.SelectMany(x => x).ToList())
        {
        }
